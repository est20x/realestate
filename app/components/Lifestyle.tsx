...
export default function Lifestyle() {
  return (
    ...
    >
      {/* Мобільна версія */}
      <div className="md:hidden flex flex-col items-center self-stretch bg-[url(/paradiseLifeBG.png)] bg-cover bg-center py-18.75 px-5">
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 lg:grid-cols-3 self-stretch gap-5.25 md:gap-6 lg:gap-8">
          <div className="flex flex-col w-full bg-white py-6.5 md:py-8 lg:py-10 px-6.5 md:px-8 lg:px-10 gap-2.25 md:gap-3 lg:gap-4 rounded-[13px] md:rounded-[15px]">
            <Image
              ...
              width={283}
              height={199}
              className="w-full h-49.75 md:h-[250px] lg:h-[300px] object-cover rounded-lg"
            />
      ...
      <div className="hidden md:flex flex-col items-center self-stretch bg-[url(/paradiseLifeBG-desktop.png)] bg-cover bg-center py-16 lg:py-24 xl:py-32 2xl:py-26 px-6 md:px-8 lg:px-12 xl:px-20 2xl:px-16">
