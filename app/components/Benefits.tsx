...
export default function Benefits() {
  return (
    <div id="benefits" className="lg:hidden overflow-hidden">
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2.5 md:gap-4 lg:gap-5 mb-2.75 md:mb-6 lg:mb-8 mt-2.75 md:mt-6 lg:mt-8 px-5 md:px-8 lg:px-12 xl:px-16">
        <div className="col-span-2 md:col-span-3 lg:col-span-2 flex flex-col items-start justify-center rounded-[5px] md:rounded-[8px] bg-[linear-gradient(180deg,#EAF7FF,#D9F1FF)] w-full h-[80.84px] md:h-[100px] lg:h-[120px]">
        ...
        <div className="flex flex-col items-start py-3 md:py-4 lg:py-5 gap-1.5 md:gap-2 rounded-[5px] md:rounded-[8px] bg-[linear-gradient(180deg,#EAF7FF,#D9F1FF)] w-full h-[98.55px] md:h-[120px] lg:h-[140px]">
          ...
          <span className="text-sm md:text-base lg:text-lg ml-5 md:ml-6 lg:ml-8 font-light text-(--color-blue-primary) -mt-4">
            Цены от <span className="font-bold">€240,000</span>
          </span>
        </div>

        <div className="col-span-2 md:col-span-3 lg:col-span-2 flex flex-col items-start py-3 md:py-4 lg:py-5 gap-1.5 md:gap-2 rounded-[5px] md:rounded-[8px] bg-[linear-gradient(180deg,#EAF7FF,#D9F1FF)] w-full h-[80.84px] md:h-[100px] lg:h-[120px]">
          <span className="text-[32px] md:text-[40px] lg:text-[48px] ml-5 md:ml-6 lg:ml-8 text-(--color-blue-primary)">
            <Emoji>🔥</Emoji>
          </span>
        ...
        <div className="col-span-2 md:col-span-3 lg:col-span-4 flex flex-col items-start py-2.75 md:py-4 lg:py-5 gap-1.5 md:gap-2 rounded-[5px] md:rounded-[8px] bg-[linear-gradient(180deg,#EAF7FF,#D9F1FF)] w-full h-[80.84px] md:h-[100px] lg:h-[120px]">
          <span className="text-[32px] md:text-[40px] lg:text-[48px] ml-5 md:ml-6 lg:ml-8 text-(--color-blue-primary)">
            <Emoji>⏳</Emoji>
          </span>
          <span className="text-sm md:text-base lg:text-lg ml-5 md:ml-6 lg:ml-8 font-light text-(--color-blue-primary) -mt-3">
